...
class ServicesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('settings')->insert([
            [
                'image_service'         => 'https://interactive.co.id/product/images/assets/home/indeo_logo.png',
            ...
            [
                'image_service'         => 'https://interactive.co.id/product/images/assets/home/inspire_logo.png',
